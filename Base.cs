...
namespace net.vieapps.Services
{
	...
	public abstract class ServiceBase : IService, IUniqueService, ISyncableService, IServiceComponent
	{
		...
		/// <returns></returns>
		public virtual async Task WriteLogsAsync(string correlationID, string developerID, string appID, ILogger logger, List<string> logs, Exception exception = null, string serviceName = null, string objectName = null, LogLevel mode = LogLevel.Information)
		{
			// prepare
				...
				(
					new[] { this.GetType().Assembly }.Concat(this.GetType().Assembly.GetReferencedAssemblies()
						.Where(a => !a.Name.IsStartsWith("System") && !a.Name.IsStartsWith("Microsoft") && !a.Name.IsStartsWith("mscorlib") && !a.Name.IsEquals("NETStandard")
							&& !a.Name.IsStartsWith("Newtonsoft") && !a.Name.IsStartsWith("WampSharp") && !a.Name.IsStartsWith("StackExchange.") && !a.Name.IsStartsWith("SixLabors")
							...
							&& !a.Name.IsStartsWith("VIEApps.Components.") && !a.Name.IsEndsWith(".Abstractions") && !a.Name.IsStartsWith("VIEApps.Services.Base")
						)
						.Select(assemblyName =>
						{
							try
		...
		protected virtual void Stop(string[] args, bool available, bool disconnect, Action<IService> next = null)
			=> this.StopAsync(args, available, disconnect, next).Execute(true);
		...
		public virtual void Dispose(string[] args, bool available = true, bool disconnect = true, Action<IService> next = null)
			=> this.DisposeAsync(args, available, disconnect, next).Execute(true);
